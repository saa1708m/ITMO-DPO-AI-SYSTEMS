...
- `eda_beijing.ipynb` — учебный ноутбук для EDA по датасету [../../resources/datasets/module_02/](../../resources/datasets/module_02/) (`beijing_air_quality_learning.csv`);
- `dvc.yaml` — пример описания шага preprocessing в DVC;
- `preprocess_beijing.py` — пример простого preprocessing-скрипта.
