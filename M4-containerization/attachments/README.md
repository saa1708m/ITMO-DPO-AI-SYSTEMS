...
- `app_dry_beans.py` — FastAPI inference-сервис для модели, обученной в модуле 3 на датасете [resources/datasets/module_03/dry_bean_learning.csv](resources/datasets/module_03/dry_bean_learning.csv);
